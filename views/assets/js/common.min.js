function fullPage() {
if (screen.width > 400) {
    var anchors = ["top","middle", "compositePanel","glassArt", "about", "contact"];
}else {
    var anchors = ["top","compositePanel","glassArt", "about", "contact"];
}
...
gtag('js', new Date());gtag('config', 'UA-115155070-1');
Barba.Dispatcher.on("newPageReady", function() {
    ...
    isSp && $(".page-top").height($(window).height()), gtag('js', new Date());
}), $(function() {
    fullPage();
    ...
    PageTransitionUnder = Barba.BaseTransition.extend({
        ...
        finish: function() {
            ...
            if (screen.width < 400) {
                ...
                $('.headerImage').remove();
                $('#headerTitle').css('fontSize', '3rem');
                $('#headerTitle').addClass("simpleHeader");
